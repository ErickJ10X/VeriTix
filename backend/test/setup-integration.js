...
// Docker publica Postgres y Redis solo en 127.0.0.1, por lo que la conexión falla con IPv6.
// Forzamos IPv4 explícitamente para el entorno de test.
if (process.env.DATABASE_URL) {
  process.env.DATABASE_URL = process.env.DATABASE_URL.replace('localhost', '127.0.0.1');
}
// Redis también usa el hostname 'redis' en docker-compose. Lo mapeamos a 127.0.0.1.
